export default function FeaturesGrid() {
  const features = [
    {
      ...
      icon: (
        <svg className="w-9 h-9 text-[#FBBF24] filter drop-shadow-[0_2px_8px_rgba(245,158,11,0.4)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section id="features" className="relative bg-[#020716] py-16 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden scroll-mt-20">
      {/* Background ambient lighting */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-blue-600/10 blur-[130px] rounded-full pointer-events-none -z-10" />
      <div className="absolute top-0 right-10 w-[300px] h-[300px] bg-amber-400/5 blur-[100px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-sm sm:text-base text-slate-300/90 max-w-2xl mx-auto mb-12 sm:mb-16 leading-relaxed font-normal">
          From admission to alumni, DigyCampusPro covers every aspect of campus management.
        </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-4">
          {features.map((item) => (
            <div
              key={item.id}
              className="bg-gradient-to-b from-[#05173B]/95 via-[#06183D]/90 to-[#030E26]/95 border border-blue-500/30 hover:border-blue-400/80 rounded-2xl p-4 sm:p-5 text-center flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_10px_30px_rgba(20,70,180,0.35)] group cursor-default"
            >
              {/* Feature Golden Icon */}
              <div className="w-12 h-12 rounded-xl bg-amber-400/10 border border-amber-400/20 flex items-center justify-center shrink-0 mb-3 group-hover:scale-110 group-hover:border-amber-400/50 group-hover:bg-amber-400/15 transition-transform duration-300">
                {item.icon}
              </div>
