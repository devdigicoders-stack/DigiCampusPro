...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative bg-[#020C07] py-20 sm:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden scroll-mt-20">
      {/* Dynamic Background Glow Elements */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[850px] h-[400px] bg-[#008744]/15 blur-[150px] rounded-full pointer-events-none -z-10" />
      <div className="absolute bottom-10 right-10 w-[350px] h-[350px] bg-[#FF7A00]/10 blur-[120px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider text-white bg-gradient-to-r from-[#FFA000] via-[#FF8000] to-[#FF6000] border border-orange-400/30 backdrop-blur-md shadow-md shadow-orange-500/20 mb-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight font-['Outfit',sans-serif] mb-4">
            Connect With Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA000] via-[#FFB347] to-[#FF7A00]">Campus Solutions Team</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-gradient-to-b from-[#061C12] to-[#030E08] border border-emerald-900/50 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden backdrop-blur-xl">
              <div className="absolute top-0 right-0 w-36 h-36 bg-emerald-500/10 rounded-full blur-2xl pointer-events-none" />

              <div className="flex items-center justify-between pb-6 mb-6 border-b border-emerald-900/40">
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-white font-['Outfit',sans-serif]">
                    Institutional Helplines
                  </h3>
                  <p className="text-xs text-emerald-200/70 mt-1">Direct reach to our Lucknow tech center</p>
                </div>
              ...
              <div className="space-y-5 text-left">
                ...
                <a
                  ...
                  className="flex items-start gap-4 p-3.5 rounded-2xl bg-white/[0.03] hover:bg-white/[0.07] border border-white/5 transition-all group cursor-pointer"
                >
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#008744] to-[#006030] flex items-center justify-center text-white shrink-0 shadow-md group-hover:scale-105 transition-transform">
                ...
                <div className="flex items-start gap-4 p-3.5 rounded-2xl bg-white/[0.03] border border-white/5">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center text-[#FFA000] shrink-0 shadow-md">
            ...
            <div className="bg-[#04140D]/90 border border-emerald-900/40 rounded-3xl p-6 text-left">
              <h4 className="text-xs sm:text-sm font-semibold text-[#FFA000] tracking-wider mb-3.5 flex items-center gap-2">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-2xl border border-slate-200 text-left relative overflow-hidden">
              ...
              <div className="mb-6 pb-5 border-b border-slate-100">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-[#008744] text-xs font-semibold mb-2">
              ...
              {isSubmitted ? (
                ...
                <div className="py-10 sm:py-14 text-center space-y-4 animate-in fade-in zoom-in-95 duration-300">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full bg-emerald-50 border-2 border-emerald-500/20 flex items-center justify-center text-[#008744] shadow-xl shadow-emerald-500/10">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 max-w-md mx-auto text-xs text-slate-600">
                    Our team will contact you at <strong className="text-[#008744] font-semibold">{formData.phone || formData.email}</strong> within 2 business hours with demo credentials.
                  </div>
                  <div className="pt-4">
                    <button
                      type="button"
                      onClick={handleReset}
                      className="px-6 py-2.5 rounded-full text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-[#FFA000] via-[#FF8000] to-[#FF6000] hover:from-[#FFB020] hover:to-[#E65C00] transition-all shadow-md cursor-pointer"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-[#008744]/30 focus:border-[#008744] transition-all bg-slate-50/50 hover:bg-white font-normal"
                        />
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-[#008744]/30 focus:border-[#008744] transition-all bg-slate-50/50 hover:bg-white font-normal"
                      >
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all cursor-pointer ${
                              isSelected
                                ? 'bg-[#008744] text-white font-semibold shadow-sm shadow-emerald-500/20'
                  ...
                  <button
                    ...
                    className="w-full py-3.5 px-6 rounded-full text-sm sm:text-base font-semibold text-white bg-gradient-to-r from-[#FFA000] via-[#FF8000] to-[#FF6000] hover:from-[#FFB020] hover:to-[#E65C00] shadow-lg shadow-orange-500/25 transition-all transform hover:scale-[1.01] active:scale-98 cursor-pointer flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
